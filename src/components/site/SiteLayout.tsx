...
const SiteLayout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background relative">
      <Header />
      <main key={pathname} className="flex-1 pt-16 md:pt-20 animate-fade-in">{children}</main>
      <Footer />
      ...
      >
        ...
        <span className="absolute -inset-2 rounded-full bg-[#25D366] opacity-30 group-hover:animate-ping" style={{ animationDuration: "2s" }} />
      </a>
    </div>
  );
};
